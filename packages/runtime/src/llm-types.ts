/**
 * Provider-agnostic LLM types. These live in @macrokit/runtime (not in
 * @macrokit/llm) because the runtime owns the contract; @macrokit/llm
 * provides concrete adapters that implement it. This keeps the dependency
 * direction one-way: llm -> runtime.
 */
...
export class LLMAdapterError extends Error {
  readonly options: { provider: string; status?: number; cause?: unknown };
  constructor(
    message: string,
