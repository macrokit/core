...
The on-device row is the **production model** of the private reference deployment (REDACTED). Exact quant: bartowski's GGUF, SHA256 `65b8fcd92af6b4fefa935c625d1ac27ea29dcb6ee14589c55a8f115ceaaa1423`, 4.4 GB. llama.cpp build `b9354`.
